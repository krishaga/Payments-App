...
export function SendMoney(){
    return <div className="flex items-center justify-center h-screen bg-gray-100" >
        <div className=" shadow-lg flex flex-col items-center w-4/12 pt-10 bg-white rounded-md">
            ...
            <div className="pt-10 w-full flex flex-col justify-center">
                ...
                <button type="button" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm w-full py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Initiate Transfer</button>
                </div>
            </div>
        </div>
    </div>
